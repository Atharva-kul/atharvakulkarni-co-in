...
function Body() {
    ...
    return (
        ...
        <div className="ml-[3rem] pt-[2rem] tracking-widest h-full">
            <span className="font-pixel font-semibold text-shadow-lg [-webkit-text-stroke:1.5px_black] text-[64px] text-[black] leading-[0.98]">I  TEACH MACHINES<br />   TO   THINK<br /> </span> <br />
            ...
            <div className="w-full h-[180px] border mt-[5%] shadow-[4px_4px_0_0_#000] bg-[#F1E0C4]/50">
        ...
        <div className="absolute z-20 ml-[45rem] mt-[45px]">
            <GlassCard />
